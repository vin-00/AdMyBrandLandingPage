export const features = [
  {
    ...
    caption: "AI-Powered Optimization",
    title: "Intelligent Media Planning",
    text: "ADmyBRAND's AI-based media mix optimization helps you plan and execute campaigns across traditional and digital channels with precision. Our algorithms analyze performance data to maximize ROI across all advertising channels.",
    button: {
  ...
  },
  {
    ...
    text: "Manage campaigns across hoardings, print, radio, TV, mobile, OOH, and social media—all from a single unified tech platform. Our programmatic capabilities and real-time analytics give you complete control over your advertising ecosystem.",
    button: {
...
export const faq = [
  {
    id: "0",
    question: "What channels does ADmyBRAND support?",
    answer:
      "ADmyBRAND supports a comprehensive range of advertising channels including traditional media (hoardings, print, radio, TV) and digital channels (mobile, OOH, social media). Our unified platform allows you to manage all these channels from a single interface.",
  },
  {
    id: "1",
    question: "How does the AI-based optimization work?",
    answer:
      "Our AI algorithms analyze performance data across all your advertising channels to recommend the optimal media mix for your campaign goals. The system continuously learns from campaign performance to improve future recommendations and maximize your ROI.",
  },
  {
    id: "2",
    question: "What are the white-label portal features?",
    answer:
      "ADmyBRAND offers customizable white-label portals for ad space sellers with single-sign-on functionality. These portals can be branded with your company's identity and allow your clients to access inventory, book ads, and view reports seamlessly.",
  },
  {
    id: "3",
    question: "How does the QR-code based campaign tracking work?",
    answer:
      "Our platform supports QR-code based campaigns for offline media, allowing you to bridge the gap between traditional and digital advertising. When users scan the QR codes, you can track engagement and conversions, providing valuable metrics for your offline campaigns.",
  },
  {
    id: "4",
    question: "Do you offer enterprise solutions?",
    answer:
      "Yes, ADmyBRAND offers scalable enterprise solutions for agencies and large brands. Our platform can handle complex campaign structures and high volumes of ad inventory across multiple markets and channels.",
  },
  {
    id: "5",
    question: "What kind of reporting and analytics are available?",
    answer:
      "Our platform provides comprehensive cross-channel performance tracking and consolidated reporting. You can access real-time analytics on campaign performance, audience engagement, conversion metrics, and ROI across all your advertising channels.",
  },
  {
    id: "6",
    question: "Can I integrate ADmyBRAND with my existing tools?",
    answer:
      "Yes, ADmyBRAND is designed to integrate with your existing marketing technology stack. We offer APIs and pre-built integrations with popular CRM, analytics, and marketing automation platforms to ensure seamless data flow.",
  },
  {
    id: "7",
    question: "How do I onboard my team to the platform?",
    answer:
      "We provide comprehensive onboarding support including training sessions, documentation, and dedicated account managers to help your team get up to speed quickly. Our platform also features intuitive user interfaces designed for easy adoption.",
  },
  {
    id: "8",
    question: "What support options are available?",
    answer:
      "ADmyBRAND offers various support options including email, chat, and phone support. Our team is available to assist with technical issues, campaign optimization, and strategic guidance to help you get the most out of our platform.",
  },
  {
    id: "9",
    question: "How does ADmyBRAND help improve advertising ROI?",
    answer:
      "ADmyBRAND improves ROI through AI-powered media mix optimization, heat maps, programmatic algorithms, and comprehensive analytics. Our platform helps you identify the most effective channels, optimize budget allocation, and make data-driven decisions to maximize your advertising returns.",
  },
];
...
export const testimonials = [
  {
    ...
    comment:
      "ADmyBRAND's unified platform has transformed how we manage our multi-channel campaigns. The real-time analytics have helped us optimize our ad spend and improve ROI by 35%.",
  },
  {
    id: "1",
    name: "Priya Sharma",
    role: "CEO, MediaMatrix",
    avatarUrl: "/images/testimonials/mark-erixon.png",
    comment:
      "The AI-based media mix optimization is a game-changer. We've been able to identify the most effective channels for our clients and deliver better results with the same budget.",
  },
  {
    id: "2",
    name: "Arun Kapoor",
    role: "Digital Strategist, AdForge",
    avatarUrl: "/images/testimonials/melanie-hurst.png",
    comment:
      "The QR-code based campaign tracking has bridged the gap between our offline and online advertising efforts. Now we can measure the impact of our billboard and print campaigns.",
  },
  {
    id: "3",
    name: "Neha Gupta",
    ...
    comment:
      "ADmyBRAND's white-label portal has allowed us to offer a seamless experience to our clients. They love the transparency and control it gives them over their campaigns.",
  },
  {
    id: "4",
    name: "Vikram Singh",
    role: "Head of Marketing, TravelEase",
    avatarUrl: "/images/testimonials/becky-snider.png",
    comment:
      "Implementing ADmyBRAND has streamlined our advertising workflow. What used to take days now takes hours, and the cross-channel reporting has given us insights we never had before.",
  },
  {
    id: "5",
    name: "Ananya Desai",
    role: "Advertising Manager, RetailPlus",
    avatarUrl: "/images/testimonials/jim-bradley.png",
    comment:
      "The heat maps and programmatic algorithms have revolutionized how we target our audiences. We're seeing higher engagement and better conversion rates across all channels.",
  },
];
...
export const socials = [
  {
    ...
    url: "https://twitter.com/admybrand",
  },
  {
    id: "1",
    title: "Facebook",
    icon: "/images/socials/threads.svg",
    url: "https://facebook.com/admybrand",
  },
  {
    id: "2",
    title: "Instagram",
    icon: "/images/socials/instagram.svg",
    url: "https://instagram.com/admybrand",
  },
  {
    id: "3",
    title: "LinkedIn",
    icon: "/images/socials/discord.svg",
    url: "https://linkedin.com/company/admybrand",
  },
];
